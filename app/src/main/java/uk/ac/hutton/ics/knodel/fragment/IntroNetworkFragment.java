...
public class IntroNetworkFragment extends Fragment
{
	...
	private Button    networkStatusSettings;
	private Button    networkStatusRefresh;
	...
	public void onActivityCreated(@Nullable Bundle savedInstanceState)
	{
		...
		if (view != null)
		{
			networkStatusImage = (ImageView) view.findViewById(R.id.network_status_image);
			networkStatusMessage = (TextView) view.findViewById(R.id.network_status_message);
			networkStatusSettings = (Button) view.findViewById(R.id.network_status_settings);
			networkStatusRefresh = (Button) view.findViewById(R.id.network_status_refresh);

			/* When 'settings' is clicked, open the wireless settings */
			networkStatusSettings.setOnClickListener(new View.OnClickListener()
			{
				@Override
			...
			networkStatusRefresh.setOnClickListener(new View.OnClickListener()
			{
				@Override
				public void onClick(View v)
				{
