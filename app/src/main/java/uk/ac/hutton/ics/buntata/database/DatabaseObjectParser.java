...
{
	/**
	 * Called when a {@link DatabaseObject} needs to be parsed from the {@link uk.ac.hutton.ics.buntata.database.DatabaseInternal.AdvancedCursor}
	 *
	 * @param context      The {@link Context}
	 * @param datasourceId The current datasource id
	 * @param cursor       The {@link uk.ac.hutton.ics.buntata.database.DatabaseInternal.AdvancedCursor}
