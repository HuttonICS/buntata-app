...
/**
 * The {@link VideoActivity} contains the {@link uk.ac.hutton.ics.knodel.fragment.DatasourceFragment}. It's used to select the data source.
 *
...
public class VideoActivity extends BaseActivity implements MediaController.MediaPlayerControl
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		sv = (SurfaceView) findViewById(R.id.video_view_surface);
	}
