...
public class AttributeValueVideoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
	...
	static class VideoViewHolder extends RecyclerView.ViewHolder
	{
		...
		VideoViewHolder(View v)
		{
			...
			view = v;
			title = (TextView) v.findViewById(R.id.video_view_title);
			link = (TextView) v.findViewById(R.id.video_view_link);
			preview = (ImageView) v.findViewById(R.id.video_view_preview);
		}
	}
