...
/**
 * {@link LocationUtils} provides methods to track user locations
 *
...
{
	/**
	 * {@link Set} of the registered {@link LocationChangeListener}s
	 */
	 ...
	 * running
	 */
	public static synchronized boolean load(Activity context) throws SecurityException
	{
	...
	/**
	 * Registers a new {@link LocationChangeListener} for updates.
	 * <p/>
	 * If there is location information at the point of registration, the {@link LocationChangeListener}
	 * will be fired immediately.
	 *
	 * @param listener The new {@link LocationChangeListener}
	 */
	...
	/**
	 * Unregisters the given {@link LocationChangeListener} from the update set
	 *
	 * @param listener The {@link LocationChangeListener} to unregister
	 */
	...
	/**
	 * {@link LocationChangeListener} is an interface used to get notified if the location
	 * changes.
	 *
	 * @author Sebastian Raubach
	 */
