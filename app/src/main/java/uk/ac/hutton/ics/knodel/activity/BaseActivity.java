...
/**
 * {@link uk.ac.hutton.ics.knodel.activity.BaseActivity} is the main {@link android.app.Activity} type of Knodel. All activities should subclass this
...
public abstract class BaseActivity extends AppCompatActivity
{
	...
	public static final int RESULT_NEW_RESOURCE_SELECTED = 100001;
	 ...
	 *
	 * @param trackerId The {@link uk.ac.hutton.ics.knodel.activity.BaseActivity.TrackerName}
	 * @return The Tracker
	 */
	...
	/**
	 * The {@link uk.ac.hutton.ics.knodel.activity.BaseActivity} will call {@link #setContentView(int)} with the result of this function.
	 * <p/>
	 * Child classes MUST NOT call {@link #setContentView(int)} themselves, but rather let {@link uk.ac.hutton.ics.knodel.activity.BaseActivity} take
	 * care of it.
	 *
	...
	/**
	 * The {@link uk.ac.hutton.ics.knodel.activity.BaseActivity} will call {@link #setSupportActionBar(Toolbar)} with the {@link Toolbar} associated
